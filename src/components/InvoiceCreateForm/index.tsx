...
import type { CustomerField, State } from '@/src/types';
import { Button } from '@/src/common/button';
import { createInvoice } from '@/src/hooks/createInvoice';

interface InvoiceCreateFormProps {
  customers: CustomerField[];
}

export const InvoiceCreateForm = ({ customers }: InvoiceCreateFormProps) => {
